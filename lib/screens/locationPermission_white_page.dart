...
class LocationPermissionWhitePage extends StatelessWidget {
  const LocationPermissionWhitePage({Key? key}) : super(key: key);
...
void main() {
  runApp(MaterialApp(
    home: const LocationPermissionWhitePage(),
    theme: ThemeData(
      fontFamily: 'NotoSans',
    ),
  ));
